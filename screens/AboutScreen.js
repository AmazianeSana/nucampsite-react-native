...
import { Card, ListItem, Avatar } from 'react-native-elements'; // Make sure these imports are correct
import { PARTNERS } from "../shared/partners"; // Ensure the path to PARTNERS is correct
